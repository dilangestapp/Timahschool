...
@if($countdowns->isNotEmpty())
    <section class="exam-countdown-zone {{ $compact ? 'exam-countdown-zone--compact' : '' }}" id="exam-countdowns">
        <div class="container exam-countdown-container">
                ...
                @foreach($countdowns as $exam)
                    <article class="exam-card exam-card--{{ $exam['color'] ?? 'blue' }}" data-exam-card data-target="{{ $exam['target_iso'] }}">
                        ...
                        <div class="exam-date-line">
                            <strong>Début :</strong> {{ $exam['start_label'] }}
                        </div>
                        <div class="exam-date-line">
                            <strong>Fin :</strong> {{ $exam['end_label'] }}
                        </div>
                        ...
                        <div class="exam-progress">
                            <span style="width: {{ $exam['progress'] }}%"></span>
                        </div>
        ...
        @push('scripts')
            <script>
                document.addEventListener('DOMContentLoaded', function () {
                    function pad(value) { return Math.max(0, value); }
