...
<style>
    .wa-page{display:grid;gap:16px}.wa-hero{background:linear-gradient(135deg,#052e2b,#128c7e 58%,#25d366);color:#fff;border-radius:28px;padding:20px;box-shadow:0 22px 60px rgba(18,140,126,.22);overflow:hidden;position:relative}.wa-hero:after{content:"";position:absolute;right:-50px;bottom:-80px;width:220px;height:220px;border-radius:999px;background:rgba(255,255,255,.12)}.wa-hero h1{margin:0 0 6px;font-size:clamp(1.5rem,3vw,2.2rem);font-weight:950}.wa-hero p{margin:0;color:#dcfce7}.wa-notice{display:flex;align-items:center;justify-content:space-between;gap:10px;background:#fff7ed;border:1px solid #fed7aa;color:#9a3412;border-radius:18px;padding:12px 14px;font-weight:900}.wa-shell{display:grid;grid-template-columns:minmax(280px,380px) minmax(0,1fr);height:min(78vh,840px);min-height:660px;background:#fff;border:1px solid #dbeafe;border-radius:28px;overflow:hidden;box-shadow:0 20px 60px rgba(15,23,42,.08)}.wa-sidebar{display:flex;flex-direction:column;background:#f8fafc;border-right:1px solid #e2e8f0;min-width:0}.wa-sidebar-head{padding:16px;background:#fff;border-bottom:1px solid #e2e8f0}.wa-sidebar-head h2{margin:0 0 12px;font-size:1.15rem;font-weight:950}.wa-search{display:flex;align-items:center;gap:8px;background:#f1f5f9;border:1px solid #e2e8f0;border-radius:999px;padding:10px 12px}.wa-search input{border:0;background:transparent;outline:0;width:100%;font-weight:800;color:#0f172a}.wa-thread-list{overflow:auto;padding:10px}.wa-thread{display:grid;grid-template-columns:50px minmax(0,1fr) auto;gap:10px;align-items:center;text-decoration:none;color:#0f172a;padding:10px;border-radius:18px;margin-bottom:7px;border:1px solid transparent}.wa-thread:hover{background:#eef7f2}.wa-thread.active{background:#e7f8ef;border-color:#9be7b3}.wa-avatar{width:50px;height:50px;border-radius:50%;display:grid;place-items:center;background:linear-gradient(135deg,#128c7e,#25d366);color:#fff;font-weight:950;font-size:1.05rem;box-shadow:0 10px 24px rgba(18,140,126,.24)}.wa-thread-title{font-weight:950;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.wa-thread-sub{font-size:.86rem;color:#64748b;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.wa-thread-time{font-size:.76rem;color:#64748b;text-align:right;font-weight:800}.wa-badge{display:inline-grid;place-items:center;min-width:23px;height:23px;border-radius:999px;background:#25d366;color:#052e2b;font-size:.74rem;font-weight:950;margin-top:6px}.wa-chat{display:flex;flex-direction:column;min-width:0;background:#efeae2;background-image:radial-gradient(rgba(18,140,126,.08) 1px,transparent 1px);background-size:18px 18px}.wa-chat-head{display:flex;align-items:center;gap:12px;background:#f8fafc;border-bottom:1px solid #e2e8f0;padding:12px 16px}.wa-chat-head h3{margin:0;font-size:1.1rem;font-weight:950}.wa-chat-head small{display:block;color:#64748b;font-weight:700}.wa-close{margin-left:auto;border:0;border-radius:12px;background:#e2e8f0;color:#0f172a;font-weight:950;padding:9px 11px;text-decoration:none}.wa-messages{flex:1;overflow:auto;padding:18px;display:flex;flex-direction:column;gap:8px}.wa-day{align-self:center;background:rgba(255,255,255,.84);border:1px solid rgba(148,163,184,.35);border-radius:999px;padding:6px 12px;font-size:.78rem;color:#64748b;font-weight:900;margin:8px 0}.wa-bubble-wrap{display:flex;flex-direction:column;max-width:min(78%,700px);align-self:flex-start}.wa-bubble-wrap.me{align-self:flex-end}.wa-bubble{position:relative;background:#fff;border-radius:18px 18px 18px 4px;padding:10px 12px;box-shadow:0 3px 10px rgba(15,23,42,.08);border:1px solid rgba(226,232,240,.8)}.wa-bubble-wrap.me .wa-bubble{background:#d9fdd3;border-color:#bbf7d0;border-radius:18px 18px 4px 18px}.wa-reply-quote{border-left:4px solid #128c7e;background:rgba(18,140,126,.08);border-radius:10px;padding:8px;margin-bottom:8px;color:#475569;font-size:.86rem}.wa-text{white-space:pre-wrap;line-height:1.45;color:#0f172a}.wa-meta{display:flex;justify-content:flex-end;gap:6px;align-items:center;color:#64748b;font-size:.72rem;font-weight:850;margin-top:6px}.wa-ticks{color:#128c7e;font-size:.9rem}.wa-attachment{display:block;text-decoration:none;color:#0f172a;border:1px solid rgba(148,163,184,.35);background:rgba(255,255,255,.72);border-radius:14px;padding:8px;margin-bottom:8px;overflow:hidden}.wa-attachment img{display:block;max-width:260px;max-height:220px;border-radius:12px;object-fit:cover}.wa-file{display:flex;align-items:center;gap:10px}.wa-file-icon{width:42px;height:42px;border-radius:12px;background:#fee2e2;color:#dc2626;display:grid;place-items:center;font-weight:950}.wa-audio{width:260px;max-width:100%}.wa-msg-tools{display:flex;gap:6px;margin-top:6px;opacity:.75}.wa-tool{border:0;background:rgba(15,23,42,.06);border-radius:999px;padding:5px 9px;font-size:.72rem;font-weight:900;cursor:pointer;color:#334155}.wa-composer{background:#f8fafc;border-top:1px solid #e2e8f0;padding:12px 14px}.wa-reply-preview{display:none;background:#e7f8ef;border-left:4px solid #128c7e;border-radius:14px;padding:10px;margin-bottom:10px;color:#0f172a}.wa-reply-preview.is-visible{display:flex;justify-content:space-between;gap:10px}.wa-compose-form{display:grid;grid-template-columns:auto auto 1fr auto;gap:10px;align-items:end}.wa-compose-form textarea{min-height:48px;max-height:140px;resize:vertical;border:1px solid #dbe3ee;border-radius:18px;padding:13px 14px;outline:none;background:#fff;font-weight:700}.wa-send{border:0;border-radius:18px;background:#25d366;color:#052e2b;font-weight:950;padding:14px 18px;cursor:pointer}.wa-file-input{display:none}.wa-attach,.wa-mic{border:1px solid #dbe3ee;background:#fff;border-radius:18px;padding:14px 16px;font-weight:950;cursor:pointer;color:#128c7e}.wa-mic.recording{background:#fee2e2;color:#dc2626;border-color:#fecaca;animation:pulse 1s infinite}@keyframes pulse{50%{transform:scale(1.04)}}.wa-file-label{display:block;margin-top:8px;color:#64748b;font-weight:850}.wa-empty{background:rgba(255,255,255,.78);border:1px dashed #cbd5e1;border-radius:18px;color:#64748b;padding:18px;font-weight:850}.wa-toast{position:fixed;left:50%;bottom:24px;transform:translateX(-50%);background:#0f172a;color:#fff;border-radius:999px;padding:10px 16px;font-weight:900;z-index:9999;opacity:0;pointer-events:none;transition:.2s}.wa-toast.show{opacity:1}@media(max-width:980px){.wa-shell{grid-template-columns:1fr;height:auto;min-height:0}.wa-sidebar{border-right:0;border-bottom:1px solid #e2e8f0;max-height:360px}.wa-chat{min-height:620px}.wa-bubble-wrap{max-width:90%}}@media(max-width:640px){.wa-hero{padding:18px;border-radius:22px}.wa-shell{border-radius:22px}.wa-compose-form{grid-template-columns:auto auto 1fr}.wa-send{grid-column:1/4}.wa-chat-head{padding:10px 12px}.wa-messages{padding:12px}.wa-bubble-wrap{max-width:94%}.wa-thread-list{max-height:300px}}
</style>

<div class="wa-page">
    <section class="wa-hero">
        <h1>💬 Messagerie TIMAH</h1>
        <p>Échange directement avec tes enseignants, envoie des documents, images ou notes vocales, et suis les messages lus.</p>
    </section>
    ...
    <section class="wa-shell">
        <aside class="wa-sidebar">
            <div class="wa-sidebar-head">
                <h2>Conversations</h2>
                <label class="wa-search">🔎 <input type="search" id="waSearch" placeholder="Rechercher un enseignant"></label>
            </div>
                ...
                @forelse($threads as $thread)
                    ...
                    <a class="wa-thread {{ (int)$selectedThreadId === (int)$thread->assignment->id ? 'active' : '' }}" data-name="{{ strtolower($teacherName . ' ' . $subject) }}" href="{{ route('student.messages.index', ['thread' => $thread->assignment->id]) }}">
                        ...
                        <div style="min-width:0">
                            <div class="wa-thread-title">{{ $teacherName }}</div>
                            <div class="wa-thread-sub">{{ $subject }} · {{ $thread->schoolClass?->name ?? $studentProfile->schoolClass->name ?? 'Classe' }}</div>
        ...
        <main class="wa-chat">
            @if($selectedThread)
                ...
                <header class="wa-chat-head">
                    <div class="wa-avatar">{{ $teacherInitials }}</div>
                    <div>
                        <h3>{{ $teacherName }}</h3>
                        <small>{{ $selectedThread->subject?->name ?? 'Matière' }} · {{ $messages->count() }} message(s)</small>
                    </div>
                    <a class="wa-close" href="{{ route('student.messages.index') }}" title="Fermer la conversation">✕</a>
                </header>
                ...
                <div class="wa-messages" id="waMessages">
                    @forelse($messages as $message)
                        ...
                        <div class="wa-bubble-wrap {{ $isMe ? 'me' : '' }}" id="msg-{{ $message->id }}">
                            <div class="wa-bubble">
                                @if($parent)
                                    <div class="wa-reply-quote"><strong>{{ $parent->isFromTeacher() ? $teacherName : 'Vous' }}</strong><br>{{ \Illuminate\Support\Str::limit($parent->message, 120) }}</div>
                                @endif
                                ...
                                <div class="wa-meta">
                                    ...
                                    @if($isMe)<span class="wa-ticks">{{ $message->read_at ? '✓✓' : '✓' }}</span>@endif
                                </div>
                            </div>
            ...
            @else
                <header class="wa-chat-head"><div class="wa-avatar">💬</div><div><h3>Sélectionne une conversation</h3><small>Choisis un enseignant à gauche pour discuter.</small></div></header>
...
(() => {
    ...
    voiceBtn?.addEventListener('click', async () => {
        if (!navigator.mediaDevices || !window.MediaRecorder) {
            showToast('Vocal non supporté sur ce navigateur');
            return;
        }
        ...
        try {
            ...
            recorder.onstop = () => {
                ...
                fileLabel.textContent = 'Note vocale prête : ' + file.name;
                showToast('Vocal prêt à envoyer');
            };
            recorder.start();
            voiceBtn.classList.add('recording');
            voiceBtn.textContent = '⏹️';
            fileLabel.textContent = 'Enregistrement vocal en cours... clique encore pour arrêter';
        } catch (e) {
            showToast('Micro refusé ou indisponible');
        }
    });

    setTimeout(() => {
        if (document.visibilityState === 'visible' && !document.querySelector('textarea:focus') && !document.querySelector('.wa-mic.recording')) {
