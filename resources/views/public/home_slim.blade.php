...
<div class="home-pro container">
    <section class="hero-pro section">
        <div class="hero-panel">
            ...
            <h1 class="hero-title">
                <span class="line line-main">Travaillez vos TD.</span>
                <span class="line">Consultez les corrigés.</span>
                <span class="line">Suivez vos progrès.</span>
            </h1>
            <p class="hero-lead">Une plateforme claire pour réviser par classe, traiter les TD, débloquer les corrigés et garder le cap jusqu’aux examens officiels.</p>
